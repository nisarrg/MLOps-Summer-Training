...
# #Collecting 500 samples of face 
while True:
    ...
    if face_extractor(frame) is not None:
        ...
        file_path = 'D:\\MLOps Summer\\Task 6\\faces\\Nisarg\\' + str(count) + '.jpg'
        ...
        pass
    if cv2.waitKey(10) == 27 or count == 350:
        break
...
data_path = 'D:\\MLOps Summer\\Task 6\\faces\\Nisarg\\'
...
while True:
    ...
    try:
        ...
        cv2.putText(image, display_string, (300, 120), cv2.FONT_HERSHEY_COMPLEX, 1, (200, 0, 200), 2)
        
        if confidence > 90:
            cv2.putText(image, "Hey Nisarg!", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,0), 2)
            cv2.imshow('Face Recognition', image)
            cv2.imwrite('D:\\MLOps Summer\\Task 6\\faces\\Nisarg\\Face.jpg', image)
            # mail()
            # whatpy()
            # break  
        else:
            cv2.putText(image, "Hey Alien!", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2)
            cv2.imshow('Face Recognition', image )
            

    except:
        cv2.putText(image, "Acess Denied!", (220, 120) , cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2)
        cv2.putText(image, "Looking for a User", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2)
        cv2.imshow('Face Recognition', image )
        pass
